...
import { ArrowLeft, Download, Bookmark, Share2, ExternalLink, Edit, AlertTriangle, Info, Calendar, Clock, Link } from 'lucide-react';
        ...
        <div className="bg-gray-800 rounded-lg p-6 mb-6 border border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {(info.pa_system || info.console_foh || info.console_monitors || info.monitor_type) && (
              <div className="bg-gray-750 rounded-lg p-4 border border-gray-700">
                <h3 className="text-lg font-semibold text-indigo-400 mb-3">Equipment Information</h3>
                <div className="grid grid-cols-2 gap-4">
                  {info.pa_system && (
                    <div>
                ...
                <tbody>
                  {inputs.map((input: any, index: number) => {
                    ...
                    return (
                      ...
                      >
                        <td className="py-2 px-2 text-indigo-300 font-medium">{input.channelNumber}</td>
                        ...
                        <td className="py-2 px-2">
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${input.phantom ? 'bg-indigo-500/20 text-indigo-300' : 'bg-gray-700 text-gray-400'}`}>
                  ...
                  {outputs.map((output: any, index: number) => {
                    ...
                    return (
                      <tr 
                        ...
                        className={`${index % 2 === 0 ? 'bg-gray-750/50' : 'bg-gray-800'} border-b border-gray-700/50`}
                      >
                        <td className="py-2 px-2 text-indigo-300 font-medium">{output.channelNumber}</td>
                        <td className="py-2 px-2 text-white font-medium">
                          {output.name}
