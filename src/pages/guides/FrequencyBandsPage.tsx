import React from "react";
    ...
    interface FrequencyBandInfo {
      ...
      status: "Available" | "Partially Available" | "No Longer Available" | "Licensed Only" | "Special Conditions";
    ...
    const frequencyData: FrequencyBandInfo[] = [
      {
        ...
        status: "Available",
        notes: "Primary spectrum for wireless microphones. WMAS permitted. Excludes 617-652 MHz & 663-698 MHz.",
      },
      {
      ...
      },
      {
        ...
        notes: "Repurposed for 600 MHz service wireless broadband. Wireless microphone operation prohibited.",
      },
      {
        ...
        <div className="min-h-screen bg-gray-900 text-white flex flex-col">
          ...
          <main className="flex-grow container mx-auto px-4 py-16">
            ...
            <p className="text-lg text-gray-400 text-center mb-12 max-w-3xl mx-auto">
              Understanding available spectrum is crucial for legal and interference-free wireless microphone operation. FCC rules have evolved, notably with the 600 MHz band repurposing. Always verify your equipment's operating frequencies.
            </p>
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl mb-12">
              <h2 className="text-2xl font-semibold text-sky-300 mb-4 flex items-center">
                <AlertTriangle className="h-6 w-6 mr-3 text-yellow-400" /> Important FCC Changes & Equipment Check
              </h2>
              <p className="text-gray-300 mb-3">
                The FCC has made significant changes to wireless microphone rules. Equipment previously operating in certain parts of the 600 MHz band (specifically 617-652 MHz and 663-698 MHz, formerly TV channels 38-51) is no longer legal for use and must be replaced or modified.
              </p>
              <p className="text-gray-300">
                <strong>Action Required:</strong> Check your wireless microphone's operating frequencies. Consult the manufacturer or user manual. Devices operating in the prohibited 600 MHz segments must cease operation.
              </p>
            </div>
            
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl mb-12">
              <h2 className="text-2xl font-semibold text-sky-300 mb-4 flex items-center">
                <Radio className="h-6 w-6 mr-3 text-sky-400" /> Wireless Multichannel Audio Systems (WMAS)
              </h2>
              <p className="text-gray-300 mb-3">
                In February 2024, the FCC authorized WMAS, a more spectrally efficient technology. WMAS transmits multiple audio channels over a wider bandwidth channel, designed for professional applications requiring many microphones (e.g., large theaters, sporting events).
              </p>
              <ul className="list-disc list-inside text-gray-300 space-y-1 mb-3">
                ...
                <li><strong>Existing conventional (non-WMAS) microphone users are NOT required to change their devices or operations due to WMAS rules.</strong></li>
              </ul>
            </div>

            <h2 className="text-3xl font-semibold text-center text-sky-300 mb-8">Frequency Band Availability Chart</h2>
            <div className="overflow-x-auto bg-gray-800 p-2 rounded-lg shadow-xl">
              <table className="min-w-full text-sm text-left text-gray-300">
                <thead className="text-xs text-gray-200 uppercase bg-gray-700">
                  <tr>
                    <th scope="col" className="px-4 py-3">Frequency Band Name</th>
                    <th scope="col" className="px-4 py-3">Frequency Range (MHz)</th>
                    <th scope="col" className="px-4 py-3">TV Channels</th>
                    <th scope="col" className="px-4 py-3">Usage Type</th>
                    <th scope="col" className="px-4 py-3">Max Unlicensed Power</th>
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-12">
                <div className="bg-gray-800 p-6 rounded-lg shadow-xl">
                    <h2 className="text-2xl font-semibold text-sky-300 mb-4 flex items-center">
                        <Info className="h-6 w-6 mr-3 text-sky-400" /> Devices "Similar" to Wireless Microphones
                    </h2>
                    <p className="text-gray-300">
                        Wireless intercoms, wireless in-ear monitors, wireless audio instrument links, and wireless cueing equipment must follow the same FCC rules as wireless microphones.
                    </p>
                </div>
                <div className="bg-gray-800 p-6 rounded-lg shadow-xl">
                    <h2 className="text-2xl font-semibold text-sky-300 mb-4 flex items-center">
                    ...
                    <p className="text-gray-300 mb-3">
                        Certain entities (e.g., broadcasters, venue owners operating 50+ mics, professional sound companies) can obtain Part 74 licenses for operating wireless mics with specified rules and interference protections.
                    </p>
                    <p className="text-gray-300">
                        Licensed operators must adhere to their license terms and use authorized bands, avoiding the repurposed 600 MHz service bands.
                    </p>
                </div>
            </div>
            ...
            <div className="mt-12 text-center text-gray-400 p-6 bg-gray-800 rounded-lg shadow-xl">
              <p className="mb-2">
                <strong>Disclaimer:</strong> This information is a summary based on FCC guidelines and is for informational purposes only.
                Always consult the official FCC website and regulations for the most current and complete information.
              </p>
              <p className="mb-2">
                Contact your equipment manufacturer or check user manuals to determine the specific frequencies your wireless microphones use.
              </p>
