        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 md:pr-12">
            ...
            <p className="text-gray-300 text-lg md:text-xl leading-relaxed">
              The ultimate tool for audio engineers and production managers to create, organize, and share
              <span className="text-indigo-300 font-medium"> patch lists, stage plots, run of shows, production schedules, </span>
          ...
          <div className="bg-gray-800 p-6 rounded-xl shadow-2xl transition-all duration-300 relative overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-850 rounded-lg p-3 border border-gray-700/50 flex items-center">
                <Music className="text-indigo-400 mr-3 h-5 w-5 flex-shrink-0" /> {/* Using Music icon for Stage Plot */}
                <div>
