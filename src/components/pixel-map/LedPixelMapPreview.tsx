  ...
  return (
    <div style={{ aspectRatio: `${width} / ${height}`, background: '#171717' }}>
      <svg viewBox={`0 0 ${viewBoxWidth} ${viewBoxHeight}`} width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="0" y="0" width={viewBoxWidth} height={viewBoxHeight} fill="none" stroke="white" strokeWidth="4" />
        ...
        {showScreenInfo && (
          <g transform={`translate(${viewBoxWidth / 2}, ${viewBoxHeight / 2})`}>
            ...
            />
            <text y="-5 * infoBoxScale" dy=".3em" fontFamily="Inter, sans-serif" fill="#FFFFFF" textAnchor="middle" fontSize={40 * infoBoxScale} fontWeight="bold">
              {screenName}
            </text>
            <text y="35 * infoBoxScale" fontFamily="Inter, sans-serif" fontSize={24 * infoBoxScale} fill="#A3A3A3" textAnchor="middle">
              {`${width}x${height}px`}
            </text>
          </g>
        )}
          ...
          <g transform={`translate(${viewBoxWidth / 2}, ${viewBoxHeight - 100 * infoBoxScale})`}>
            ...
            <text fontFamily="Inter, sans-serif" textAnchor="middle" fill="#A3A3A3">
              <tspan x="0" y={-10 * infoBoxScale} fontSize={22 * infoBoxScale}>
                ...
                <tspan dx="1.5em" fill="#FFFFFF" fontWeight="bold">{`Aspect Ratio: ${aspectWidth}:${aspectHeight}`}</tspan>
              </tspan>
        ...
        {showFooter && (
          <g>
            ...
            <text x={15 * infoBoxScale} y={viewBoxHeight - 15 * infoBoxScale} fontFamily="Inter, sans-serif" fontSize={16 * infoBoxScale} fill="#A3A3A3" textAnchor="start">
              {projectName}
            </text>
            <text x={viewBoxWidth - 15 * infoBoxScale} y={viewBoxHeight - 15 * infoBoxScale} fontFamily="Inter, sans-serif" fontSize={16 * infoBoxScale} fill="#A3A3A3" textAnchor="end">
              Generated by{' '}
