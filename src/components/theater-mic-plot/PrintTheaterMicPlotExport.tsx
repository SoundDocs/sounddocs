                  ...
                  <div key={actor.id || index} className="actor-card-print">
                    <div className="flex flex-row gap-4">
                      <div className="flex-shrink-0 w-[130px]">
                        {actor.photo_url ? (
                          <img src={actor.photo_url} alt={actor.actor_name || 'Actor'} className="actor-photo-print" />
                        ) : (
                        ...
                        <h3 className="text-md font-semibold text-black mt-2 break-words w-full">{actor.actor_name || "N/A"}</h3>
                        {actor.character_names && <p className="text-xs text-gray-600 break-words w-full">{actor.character_names}</p>}
                      </div>
