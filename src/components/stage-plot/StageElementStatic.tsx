...
const StageElementStatic: React.FC<StageElementStaticProps> = ({
  ...
  const getDefaultDimensions = () => {
    ...
    switch (type) {
      ...
      case "text": return { width: 120, height: 40 };
  ...
  const getIconForType = (type: string) => {
    ...
    switch (type) {
      ...
      case "bass-guitar": return <Guitar {...iconProps} />;
      case "keyboard": return <Piano {...iconProps} />;
      case "drums":
      case "percussion": return <Drum {...iconProps} />;
      case "violin":
      case "cello": return <Violin {...iconProps} />;
      case "trumpet":
      case "saxophone": return <Music {...iconProps} />;
      case "generic-instrument": return <CircleEllipsis {...iconProps} />;
      case "custom-image": return <ImageIcon {...iconProps} />;
