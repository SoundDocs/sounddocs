...
import { Mic, Music, Speaker, Square, Type, Users, Headphones, Volume2, Piano, Guitar, Blinds as Violin, Drum, Drumstick, Plug, CircleEllipsis } from 'lucide-react';
      ...
      >
        {type === 'text' ? (
          ...
          <>
            ...
            >
              <span 
                className="text-xs text-white bg-gray-800/90 border border-gray-600 px-2 py-1 rounded-md shadow-md min-w-[80px] inline-block text-center"
              >
                {label}
              </span>
            </div>
