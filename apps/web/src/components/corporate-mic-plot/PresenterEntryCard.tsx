    ...
    <div className="bg-gray-800 p-4 md:p-6 rounded-xl shadow-lg mb-6">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="md:w-1/3 flex flex-col items-center">
          ...
          >
            {entry.photo_url ? (
              <img
                src={entry.photo_url}
                alt={entry.presenter_name || "Presenter"}
        ...
        <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label
              htmlFor={`presenter_name_${entry.id}`}
          ...
          <div>
            <label
              htmlFor={`session_segment_${entry.id}`}
              className="block text-sm font-medium text-gray-300 mb-1"
            >
              Session/Segment
            </label>
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                handleInputChange("mic_type", e.target.value as PresenterEntry["mic_type"])
              }
              className="w-full bg-gray-700 border border-gray-600 text-white rounded-md p-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
            >
              {MIC_TYPES.map((opt) => (
          ...
          <div>
            <label
              htmlFor={`element_channel_${entry.id}`}
              className="block text-sm font-medium text-gray-300 mb-1"
            >
          ...
          <div>
            <label
              htmlFor={`tx_pack_location_${entry.id}`}
              className="block text-sm font-medium text-gray-300 mb-1"
            >
              Transmitter Pack Location
            </label>
            <input
              type="text"
          ...
          <div>
            <label
              htmlFor={`sound_check_time_${entry.id}`}
              className="block text-sm font-medium text-gray-300 mb-1"
            >
              Sound Check Time
            </label>
          ...
          <div>
            <label
              htmlFor={`presentation_type_${entry.id}`}
              className="block text-sm font-medium text-gray-300 mb-1"
            >
              Presentation Type
            </label>
            <select
              ...
              onChange={(e) =>
                handleInputChange(
                  "presentation_type",
                  e.target.value as PresenterEntry["presentation_type"],
                )
              }
              className="w-full bg-gray-700 border border-gray-600 text-white rounded-md p-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
            >
          ...
          <div className="sm:col-span-2 flex items-center justify-between">
            <div className="flex items-center">
              ...
              />
              <label
                htmlFor={`remote_participation_${entry.id}`}
