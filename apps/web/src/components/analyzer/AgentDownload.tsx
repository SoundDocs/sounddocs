...
function AgentDownload() {
  const downloadInstaller = (platform: "macos" | "windows") => {
    const filename =
      platform === "macos" ? "SoundDocsAgent-macOS.pkg" : "SoundDocsAgent-Windows.exe";
    ...
    <div className="p-4 rounded-lg bg-gray-800 border border-gray-700">
      ...
      <div className="text-xs text-gray-500">
        ...
        <ol className="list-decimal list-inside space-y-1">
          ...
          <li>
            <strong>Windows:</strong> Run the .exe file as administrator and follow the setup
            wizard.
          </li>
          <li>Launch "SoundDocs Capture Agent" from your Applications folder or Start Menu.</li>
        </ol>
      </div>
    </div>
  );
