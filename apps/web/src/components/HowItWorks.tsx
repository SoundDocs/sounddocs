...
const steps = [
  {
    ...
    description:
      "Start with templates or build from scratch. Add instruments, input lists, and technical requirements.",
    image:
      "https://images.pexels.com/photos/8412468/pexels-photo-8412468.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
  },
  {
    icon: <Layout className="h-12 w-12 text-indigo-400" />,
    title: "Design Your Stage Plot",
    description:
      "Drag and drop instruments, microphones, and equipment to create accurate stage layouts.",
    image:
      "https://images.pexels.com/photos/164693/pexels-photo-164693.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
  },
  {
    icon: <Share2 className="h-12 w-12 text-indigo-400" />,
    title: "Share & Export",
    description:
      "Generate PDF files or shareable links to distribute to your team, venues, or artists.",
    image:
