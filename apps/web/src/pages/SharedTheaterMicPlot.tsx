        ...
        {actors.length > 0 ? (
              ...
              <div key={actor.id || index} className="bg-gray-800 rounded-lg p-6 shadow-md">
                <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4">
                  ...
                  <div className="flex-grow">
                    ...
                    {actor.character_names && (
                      <p className="text-purple-400 text-sm">{actor.character_names}</p>
                    )}
                  </div>
                </div>
                ...
                {actor.costume_notes && (
                  <div className="mt-4 bg-gray-700/50 p-3 rounded-md">
                    <p className="text-gray-400 font-medium flex items-center">
                      <Shirt className="h-4 w-4 mr-2 text-purple-400" />
                      Costume Notes
                    </p>
          ...
          <div className="text-center py-10 bg-gray-800 rounded-lg">
            ...
            <p className="text-sm text-gray-400">
              This theater mic plot currently has no actors listed.
            </p>
          </div>
        )}
      </div>
        ...
        <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4 mb-6 flex items-start">
          ...
          <div>
            <p className="text-purple-300 text-sm">
              <span className="font-medium">Shared document:</span> You are viewing a shared theater
              mic plot.
