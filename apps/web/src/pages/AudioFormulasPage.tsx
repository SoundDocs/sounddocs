...
const FormulaCard: React.FC<{
  ...
  textColor: string;
  iconColor: string;
}> = ({ title, description, icon: Icon, linkTo, borderColor, textColor, iconColor }) => (
  <RouterLink
    to={linkTo}
  ...
  >
    <div className="flex items-center mb-4">
      <Icon
        className={`mr-4 h-10 w-10 ${iconColor} transition-transform duration-300 group-hover:scale-110`}
      />
