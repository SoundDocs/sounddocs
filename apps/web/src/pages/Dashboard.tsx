    ...
    <div className="min-h-screen bg-gray-900 flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-12 mt-12">
        <div className="mb-10 text-center">
          ...
          {nameUpdateError && <p className="text-red-400 text-sm mt-2">{nameUpdateError}</p>}
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  {card.icon}
                  <ChevronRight
                    className={`h-7 w-7 text-gray-500 ${styles.textHover} transition-colors`}
                  />
                </div>
                <h2
                  className={`text-2xl font-semibold text-white mb-2 ${styles.textHover} transition-colors`}
                >
                  {card.title}
                </h2>
