        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <h2 className="text-2xl font-semibold text-white mb-3">Projection or LCD Screen</h2>
              <p className="text-gray-400">
                For standard displays with known resolutions like 1920x1080 (16:9), 4K, etc. Ideal
                for presentations and standard video playback.
              </p>
            </div>
            ...
            >
              ...
              <h2 className="text-2xl font-semibold text-white mb-3">LED Video Wall</h2>
              <p className="text-gray-400">
                For custom-sized video walls built from individual LED tiles. Define your canvas by
                the number of tiles and their pixel pitch.
              </p>
            </div>
          </div>
        </div>
