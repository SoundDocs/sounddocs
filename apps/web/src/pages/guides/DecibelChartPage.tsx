...
const commonSoundLevels: SoundLevelExample[] = [
  ...
  {
    source: "Motorcycle (at 25 ft), Power Mower",
    level_dBSPL: "90 dB",
    perception: "Very Loud, Hearing damage possible with prolonged exposure",
  },
  { source: "Chainsaw, Subway Train", level_dBSPL: "100 dB", perception: "Extremely Loud" },
  {
    source: "Rock Concert (near speakers), Nightclub",
    level_dBSPL: "110-120 dB",
    perception: "Painfully Loud, Immediate risk",
  },
  {
    source: "Jet Engine (at 100 ft), Firecracker",
    level_dBSPL: "130-140 dB",
    perception: "Threshold of Pain, Immediate damage",
  },
  {
    source: "Rocket Launch",
    level_dBSPL: "180+ dB",
    perception: "Instantaneous, Irreversible Damage",
  },
];
...
const oshaPermissibleLimits: OshaLimit[] = [
  ...
  {
    level_dBA: "120 dBA",
    duration_hours: "Avoid exposure above this level without hearing protection",
  },
];
    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-16">
        ...
        <p className="text-lg text-gray-400 text-center mb-12 max-w-3xl mx-auto">
          Understanding decibels is key to audio work and hearing safety. This guide covers common
          dB scales, sound level examples, and OSHA's guidelines for noise exposure.
        </p>
        ...
        <section className="mb-16 bg-gray-800 p-6 rounded-lg shadow-xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-700 p-4 rounded">
              <h3 className="text-xl font-medium text-sky-200 mb-2">
                dBSPL (Sound Pressure Level)
              </h3>
              <p className="text-gray-300">
                Measures the intensity of sound in the air relative to the threshold of human
                hearing (0 dBSPL). Used for acoustic measurements (e.g., room noise, speaker
                output).
              </p>
            </div>
            <div className="bg-gray-700 p-4 rounded">
              ...
              <p className="text-gray-300">
                An electrical voltage reference, where 0 dBu = 0.775 Volts. Common in professional
            ...
            <div className="bg-gray-700 p-4 rounded">
              ...
              <p className="text-gray-300">
                Another electrical voltage reference, where 0 dBV = 1 Volt. Often used in consumer
                and some semi-pro audio gear.
              </p>
            </div>
            <div className="bg-gray-700 p-4 rounded">
              <h3 className="text-xl font-medium text-sky-200 mb-2">dBFS (Decibels Full Scale)</h3>
              <p className="text-gray-300">
                Measures digital audio signal levels, where 0 dBFS is the maximum possible level
                before digital clipping occurs. All values are negative or zero.
              </p>
            </div>
          </div>
          <p className="text-gray-400 mt-6">
            <strong>Key takeaway:</strong> Decibels are logarithmic and always represent a ratio
            relative to a reference point. The reference changes depending on the dB scale (e.g.,
            SPL, u, V, FS).
          </p>
        </section>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-semibold text-center text-sky-300 mb-8 flex items-center justify-center">
            <AlertTriangle className="h-8 w-8 mr-3 text-yellow-400" /> OSHA Permissible Noise
            Exposure Limits
          </h2>
          <div className="bg-gray-800 p-6 rounded-lg shadow-xl mb-6">
            <p className="text-gray-300 mb-3">
              The Occupational Safety and Health Administration (OSHA) sets legal limits on noise
              exposure in the workplace. These are based on a time-weighted average (TWA) over an
              8-hour day. If the noise level increases by 5 dBA, the permissible exposure time is
              halved.
            </p>
            <p className="text-gray-300">
              OSHA's Action Level is 85 dBA (TWA), requiring employers to implement a hearing
              conservation program. The Permissible Exposure Limit (PEL) is 90 dBA (TWA).
            </p>
          </div>
          <div className="overflow-x-auto bg-gray-800 p-2 rounded-lg shadow-xl">
            <table className="min-w-full text-sm text-left text-gray-300">
              <thead className="text-xs text-gray-200 uppercase bg-gray-700">
                <tr>
                  ...
                  <th scope="col" className="px-4 py-3">
                    Maximum Permissible Duration per Day
                  </th>
                </tr>
              </thead>
              <tbody>
        ...
        <section className="mb-16 bg-gray-800 p-6 rounded-lg shadow-xl">
          ...
          <ul className="list-disc list-inside text-gray-300 space-y-2">
            <li>
              <strong>Use Hearing Protection:</strong> Wear earplugs or earmuffs in loud
              environments (concerts, power tool use, etc.). Ensure they have an appropriate Noise
              Reduction Rating (NRR).
            </li>
            <li>
              <strong>Limit Exposure Time:</strong> Reduce the amount of time you spend in noisy
              settings.
            </li>
            <li>
              <strong>Maintain Distance:</strong> Increase your distance from loud sound sources.
              Sound intensity decreases significantly with distance.
            </li>
            <li>
              <strong>Turn Down the Volume:</strong> Especially with headphones and personal
              listening devices. If others can hear your music, it's too loud.
            </li>
            <li>
              <strong>Take Quiet Breaks:</strong> Give your ears a rest from loud sounds
              periodically.
            </li>
            <li>
              <strong>Get Regular Hearing Checks:</strong> Especially if you are frequently exposed
              to loud noise.
            </li>
          </ul>
        </section>
        ...
        <div className="mt-12 text-center text-gray-400 p-6 bg-gray-800 rounded-lg shadow-xl">
          <p className="mb-2">
            <strong>Disclaimer:</strong> This information is for educational purposes and summarizes
            common knowledge and OSHA guidelines. Always consult official OSHA documentation and
            qualified audiologists for specific workplace safety requirements and personal hearing
            health advice.
          </p>
          <p className="font-semibold text-yellow-300">
            OSHA guidelines can be updated. Always refer to the official OSHA website for the most
            current regulations.
          </p>
        </div>
      </main>
