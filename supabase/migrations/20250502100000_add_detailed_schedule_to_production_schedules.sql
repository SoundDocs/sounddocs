...
COMMENT ON COLUMN production_schedules.detailed_schedule_items IS 'Stores detailed schedule items: id, date, start_time, end_time, activity, notes, assigned_crew_ids (array of strings)';
