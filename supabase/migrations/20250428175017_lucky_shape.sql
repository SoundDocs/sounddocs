/*
  # Fixed shared resource policies

  1. Security Updates
    - Drop previous problematic RLS policies for shared resources
    - Create clearer RLS policies for shared resources with improved SQL syntax
    - Fix permission issues with anonymous users accessing shared resources

  2. Changes:
    - Explicitly use column references in USING clauses for better SQL performance
    - Use more explicit joins between tables for better query planning
    - Set clear boundaries between view-only and edit access for shared resources
*/
